...
if(loader_post_isset("user_token")&&loader_post_isset("location_lat")&&loader_post_isset("location_lng"))
{
	...
	else
	{
		...
		{
			$query1 = "UPDATE tbl_driver_info SET fld_location_lat = '".$location_lat."',fld_location_lng = '".$location_lng."', fld_location_datetime = '".$curr_datetime."'  WHERE fld_user_token = '".$user_token."' ";
