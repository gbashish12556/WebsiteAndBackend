...
*/
	...
	loader_file_put_content('post_data','completed_booking_list',$_REQUEST);
if(loader_post_isset("user_token")&&loader_post_isset("page_no"))
{
	...
	else
	{
		...
		{
			$offset = ($page_no*5);
			$where1 = "WHERE customer_token = '".$user_token."' AND is_cancelled = '0' AND is_completed = '1'";
			...
			loader_file_put_content('query_data','completed_booking_list',$query1);
	...
	loader_file_put_content('send_data','completed_booking_list',$send_data);
}
