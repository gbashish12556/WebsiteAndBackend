<?php
	loader_file_put_content('post_data','get_detail',$_REQUEST);
if(loader_post_isset("crn_no"))
{
	...
	else
	{
			...
			loader_file_put_content('query_data','get_detail',$query1);
	...
	loader_file_put_content('send_data','get_detail',$send_data);
}
