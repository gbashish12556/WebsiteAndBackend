<?php
    loader_file_put_content('post_data','register_driver_device',$_REQUEST);
if(loader_post_isset('user_token')&&loader_post_isset('gcm_regid')){
	...
	else
	{
		if(validate_driver_token($user_token))
		{
			...
			loader_file_put_content('query_data','register_driver_device',$query1);
	...
	loader_file_put_content('send_data','register_driver_device',$send_data);
}
