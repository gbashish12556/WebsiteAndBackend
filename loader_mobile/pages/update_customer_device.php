<?php
	loader_file_put_content('post_data','update_customer_device',$_REQUEST);
if(loader_post_isset("user_token")&&loader_post_isset('gcm_regid'))
{
      ...
      if(validate_user_token($user_token))
  		{
  			...
  			loader_file_put_content('query_data','update_customer_device',$query1);
    ...
    $send_data = json_encode($userRow);
  	...
  	loader_file_put_content('send_data','update_customer_device',$send_data);
