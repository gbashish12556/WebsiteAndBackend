...
*/
	...
	loader_file_put_content('post_data','future_booking_list',$_REQUEST);
if(loader_post_isset("user_token")&&loader_post_isset("page_no"))
{
	...
	else
	{
		if(validate_user_token($user_token))
		{
			...
			loader_file_put_content('query_data','future_booking_list',$query1);
	...
	loader_file_put_content('send_data','future_booking_list',$send_data);
}
