...
$mailTemplate['feedback_subject'] = '%%NAME%%-%%SUBJECT%%';
...
$mailTemplate['feedback_content'] = '<span style="font-size:15px; font-weight:bold;">Message From:- %%NAME%%</span><br/>
                  <span style="font-size:15px; font-weight:bold;">Mail From:- %%PHONE%%</span><br/>
                  <span style="font-size:15px; font-weight:bold;">Message:- %%MESSAGE%%</span><br/><br/>';
